...
(function(exports) {
  ...
  exports["applicativeBehavior"] = applicativeBehavior;
  exports["semigroupBehavior"] = semigroupBehavior;
...
(function(exports) {
  ...
  var scene = function (v) {
      var drawPoint = function (v1) {
          return function (inSet) {
              ...
              if (v2) {
                  return Graphics_Drawing.filled(Graphics_Drawing.fillColor(Color.black))(Graphics_Drawing.rectangle(v1.x)(v1.y)(10.0)(10.0));
              };
              if (!v2) {
                  var v3 = Data_Set.member(Data_Ord.ordInt)(32)(inSet);
                  if (v3) {
                      return Graphics_Drawing.filled(Graphics_Drawing.fillColor(Color.black))(Graphics_Drawing.circle(v1.x)(v1.y)(10.0));
                  };
                  if (!v3) {
                      return Graphics_Drawing.filled(Graphics_Drawing.fillColor(Color.white))(Graphics_Drawing.circle(v1.x)(v1.y)(10.0));
                  };
                  throw new Error("Failed pattern match at Main line 44, column 42 - line 46, column 98: " + [ v3.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 42, column 28 - line 46, column 98: " + [ v2.constructor.name ]);
          };
      };
      var background = Graphics_Drawing.filled(Graphics_Drawing.fillColor(Color.white))(Graphics_Drawing.rectangle(0.0)(0.0)(v.w)(v.h));
      return Data_Semigroup.append(FRP_Behavior.semigroupBehavior(Graphics_Drawing.semigroupDrawing))(Control_Applicative.pure(FRP_Behavior.applicativeBehavior)(background))(Control_Apply.apply(FRP_Behavior.applyBehavior)(Data_Functor.map(FRP_Behavior.functorBehavior)(drawPoint)(position))(FRP_Behavior_Keyboard.keys));
  };
  var main = function __do() {
      ...
      return FRP_Event.subscribe(FRP_Behavior.sample_(scene({
          w: v2, 
          h: v3
      }))(FRP_Event_Time.interval(10)))(Graphics_Drawing.render(v1))();
  };
